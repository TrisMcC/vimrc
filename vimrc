...
" Sane vim defaults
se et ts=4 sw=4 sts=4 ai ru bs=2 hid is hls ch=2 aw ls=2 stl=%!MyStatus()

" GUI - hide all chrome and pick a nice font
se go-=m go-=T go-=r go-=L gfn=DejaVu_Sans_Mono:h10:cANSI

" colors
colo darkblue | hi ColorColumn guibg=#000060 ctermbg=darkgrey
